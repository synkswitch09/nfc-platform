...
const optionalCanonical = z
  ...
  .trim()
  .url()
  .refine((value) => value.startsWith("https://"), "Use an HTTPS canonical URL")
  .or(z.literal(""));
...
export const contentPageSchema = z.object({
  ...
  kind: z
    .nativeEnum(ContentPageKind)
    .refine(
      (kind) => kind !== ContentPageKind.CATEGORY,
      "Category pages are managed from Categories",
    ),
