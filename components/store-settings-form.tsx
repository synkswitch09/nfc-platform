...
type Settings = {
  ...
  headerConfig: { logoUrl: string; homeLabel: string; faqLabel: string; faqHref: string; shopLabel: string; signInLabel: string; accountLabel: string; showHome: boolean; showFaq: boolean; showCart: boolean };
  footerConfig: { logoUrl: string; copyright: string; tagline: string; termsLabel: string; privacyLabel: string; showTerms: boolean; showPrivacy: boolean; customLinks: Array<{ label: string; href: string; visible: boolean; order: number }> };
  capabilities: string[];
};
...
export function StoreSettingsForm({ settings, domains, platformAdmin, availableCapabilities }: { settings: Settings; domains: Domain[]; platformAdmin: boolean; availableCapabilities: string[] }) {
  ...
  async function submit(event: FormEvent<HTMLFormElement>) {
    ...
    const payload = {
      ...
      headerConfig: { logoUrl: form.get("headerLogoUrl"), homeLabel: form.get("homeLabel"), faqLabel: form.get("faqLabel"), faqHref: form.get("faqHref"), shopLabel: form.get("shopLabel"), signInLabel: form.get("signInLabel"), accountLabel: form.get("accountLabel"), showHome: form.get("showHome") === "on", showFaq: form.get("showFaq") === "on", showCart: form.get("showCart") === "on" },
      footerConfig: { logoUrl: form.get("footerLogoUrl"), copyright: form.get("copyright"), tagline: form.get("tagline"), termsLabel: form.get("termsLabel"), privacyLabel: form.get("privacyLabel"), showTerms: form.get("showTerms") === "on", showPrivacy: form.get("showPrivacy") === "on", customLinks: parseFooterLinks(String(form.get("customFooterLinks") ?? "")) },
