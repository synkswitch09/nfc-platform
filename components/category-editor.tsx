...
const visualThemeOptions: Array<{ value: CategoryEditorInitial["visualTheme"]; label: string; colours: string }> = [
  { value: "CORAL", label: "Pastel peach", colours: "peach, cream and charcoal" },
  { value: "SKY", label: "Pastel sky", colours: "powder blue, mist and charcoal" },
  { value: "MIDNIGHT", label: "Pastel mint", colours: "mint, soft green and charcoal" },
  { value: "VIOLET", label: "Pastel lilac", colours: "lilac, lavender and charcoal" },
  { value: "AMBER", label: "Pastel butter", colours: "butter yellow, cream and charcoal" },
];
