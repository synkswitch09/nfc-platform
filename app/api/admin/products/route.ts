  ...
  try {
    const product = await db.$transaction(async tx => {
      ...
      const created = await tx.product.create({ data: {
        ...
        countryOfOrigin: data.countryOfOrigin || null, customsDescription: data.customsDescription || null, hsCode: data.hsCode || null, customsValueCents: data.customsValueCents, dutiesHandling: data.dutiesHandling, restrictedItem: data.restrictedItem,
