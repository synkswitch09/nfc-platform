...
export default async function ManufacturingPage() {
  ...
  return <div>
    <div className="admin-heading"><div><p className="admin-kicker">Manufacturing · {store.displayName}</p><h1>Production queue</h1><p>Generic 3D print, finishing, QA, assembly and packing work by order item.</p></div></div>
    ...
    <section className="admin-panel flush">
      <div className="admin-table manufacturing-job-table"><div className="admin-tr admin-th"><span>Product</span><span>Order</span><span>Material</span><span>Work</span><span>Status</span></div>{jobs.map(job => {
