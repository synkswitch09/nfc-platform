...
export default async function NewCategoryPage() {
  ...
  return <div><div className="admin-heading"><div><p className="admin-kicker">Content · {store.displayName}</p><h1>New category</h1><p>Create structured content as a draft, then publish when it is ready.</p></div></div><CategoryEditor initial={initial} /></div>;
}
